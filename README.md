# Quick Start
```
python3 TFLite_detection_webcam.py --modeldir=Sample

```
Open http://localhost:8080/cam.html for Checking video result
Or get Streaming data with http://localhost:8080/cam.mjpg for other apps.
